...
class SkyClassLightningModel(pl.LightningModule):
    """
    Lightning model for training and evaluating a classification head model.
    """
    ...
    def __init__(
        ...
        """
        Initialize the SkyClassLightningModel.
        ...
        """
        super(SkyClassLightningModel, self).__init__()
